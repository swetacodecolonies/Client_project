...
export const OderStatus:ChartOptions | any = {
    chart: {
        height: 350,
        type: "line",
        stacked: true,
...
export const uses :ChartOptions |any = {
    chart: {
      ...
      series: [
        ...
        {
          name: "Bubble2",
          data: generateData(new Date("12 Feb 2023 GMT").getTime(), 20, {
            min: 10,
            max: 60,
          }),
        },
        {
          name: "Bubble3",
          data: generateData(new Date("26 Feb 2023 GMT").getTime(), 20, {
            min: 10,
            max: 60,
          }),
        },
        {
          name: "Bubble4",
          data: generateData(new Date("01 Feb 2023 GMT").getTime(), 20, {
            min: 10,
            max: 60,
          }),
        },
